...
<h2><?php echo __('Field Ownership'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($fieldOwnership['FieldOwnership']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($fieldOwnership['FieldOwnership']['user_id']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Field Ownership'), array('action' => 'edit', $fieldOwnership['FieldOwnership']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Field Ownership'), array('action' => 'delete', $fieldOwnership['FieldOwnership']['id']), array(), __('Are you sure you want to delete # %s?', $fieldOwnership['FieldOwnership']['id'])); ?> </li>
